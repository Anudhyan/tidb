...
func main() {
	// Testing Max and Min
	fmt.Println("Max:", Max(1, 2, 3, 4))              // Example for integers
	fmt.Println("Min:", Min(1, 2, 3, 4))              // Example for integers
	fmt.Println("Max floats:", Max(3.1, 5.2, 2.8))    // Example for floats
	fmt.Println("Min floats:", Min(3.1, 5.2, 2.8))    // Example for floats
	fmt.Println("Max strings:", Max("apple", "banana")) // Example for strings

	// Testing Clamp
	fmt.Println("Clamp:", Clamp(5, 1, 10)) // Should be 5
	fmt.Println("Clamp:", Clamp(15, 1, 10)) // Should be 10
	fmt.Println("Clamp:", Clamp(-5, 1, 10)) // Should be 1

	// Testing NextPowerOfTwo
	fmt.Println("Next Power of Two:", NextPowerOfTwo(5)) // Should be 8
	fmt.Println("Next Power of Two:", NextPowerOfTwo(16)) // Should be 16

	// Testing Divide2Batches
	fmt.Println("Divide2Batches:", Divide2Batches(10, 3)) // Example for dividing 10 into 3 batches

	// Testing StrLenOfInt64Fast
	fmt.Println("StrLenOfInt64Fast:", StrLenOfInt64Fast(-1234567890)) // Should print the length of the number
}
